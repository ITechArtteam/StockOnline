...
export const SET_WAYBILL_INFO_MODAL_VISIBILITY = "waybillsForm/SET_WAYBILL_INFO_MODAL_VISIBILITY";
export const SET_WAYBILL_INFO_MODAL_DATA = "waybillsForm/SET_WAYBILL_INFO_MODAL_DATA";
